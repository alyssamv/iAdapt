...
Note that, as we've specified them, we have monotone dose-toxicity and dose-efficacy curves, as shown below. If we have a cutoff dose-limiting toxicity (DLT) rate of 0.40, (horizontal dotted line, figure a), then our target dose is dose 4 (green point). Using a likelihood framework, our design should, on average, choose this dose-level with high accuracy.
