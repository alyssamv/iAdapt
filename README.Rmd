...
```{r}
eq = function(x){x}
plot(eq(1:6), type = 'b', yaxt = "n",
     xlab = "Increasing dose", ylab = "")
title(main = "Fig. 1: Monotone dose-response relationship",
     ylab = "Response level", line = 1)


eq = function(x){-x^2}
plot(eq(-3:2), type = 'b', yaxt = "n",
     xlab = "Increasing dose", ylab = "")
title(main = "Fig. 2: Non-monotone dose-response relationship",
     ylab = "Response level", line = 0.5)
